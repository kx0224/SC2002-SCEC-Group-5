...
//                        if (userUpdated) {
//                            System.out.println("User information updated successfully in the user list.");
//                        } else {
//                            System.out.println("Warning: User not found in the list.");
//                        }
//                    } else {
//                        System.out.println("Warning: No users found for this role.");
//                    }
                    break;}
                } else {
    ...
    public void setPhonenumber(String phonenumber) {
        this.phonenumber = phonenumber;  // Correct assignment
    }
