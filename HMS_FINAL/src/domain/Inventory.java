...
//    public void addMedication(String name, int initialStock, int lowStockAlert) {
//        String generatedId = generateMedId();
//        if (!inventory.containsKey(generatedId)) {
//            Medication newMedication = new Medication(name, initialStock, lowStockAlert);
//            newMedication.setMed_id(generatedId);
//            inventory.put(generatedId, newMedication);
//            System.out.println("Medication added: " + name + " with ID: " + generatedId);
//        } else {
//            System.out.println("Medication with ID " + generatedId + " already exists.");
//        }
//    }
...
//    // Method to remove medication by ID
//    public void removeMedication(String id) {
//        if (inventory.containsKey(id)) {
//            inventory.remove(id);
//            System.out.println("Medication removed with ID: " + id);
//        } else {
